...
- [SimpleWorkerNet](#simpleworkernet)
  ...
  - [🌟 Особенности](#-особенности)
    ...
    - [🗄️ Умное кэширование](#️-умное-кэширование)
  ...
  - [🎨 Примеры использования](#-примеры-использования)
    ...
    - [⚙️ Препроцессор данных API](#️-препроцессор-данных-api)
  ...
  - [🗺️ Графовая топология (Topology)](#️-графовая-топология-topology)
    ...
    - [🗂️ Структура хранения графов](#️-структура-хранения-графов)
    - [💡 Пример полного рабочего процесса](#-пример-полного-рабочего-процесса)
...
## <a name="topology"></a>🗺️ Графовая топология (Topology)
